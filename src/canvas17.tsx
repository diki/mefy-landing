...
const CanvasComponent = () => {
  ...
  useEffect(() => {
    ...
    // Function to recursively draw the binary tree with randomness
    const drawTree = (depth, x, y) => {
      ...
      // Randomize the existence of children
      const hasLeftChild = Math.random() > 0.2; // 80% chance of left child
      const hasRightChild = Math.random() > 0.2; // 80% chance of right child
